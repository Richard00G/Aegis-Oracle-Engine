...
export const getContract = async () => {
    ...
    const mock2 = new ethers.Contract("0xe7f1725E7734CE288F8367e1Bb143E90bb3F0512", mockAbi.abi, signer);
    const mock3 = new ethers.Contract("0x9fE46736679d2D9a65F0992F2272dE9f3c7fa6e0", mockAbi.abi, signer);
    return { contract, mock, mock2, mock3 };
}
